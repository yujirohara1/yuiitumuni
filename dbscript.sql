...
select '富士通' vendor_nm, 1 bunya_cd,'住民基本台帳'   bunya_nm , 12 kensu , '住基' ryaku_nm union all 
select '富士通' vendor_nm, 2 bunya_cd,'選挙人名簿管理' bunya_nm ,  4 kensu , '選挙' ryaku_nm union all 
select '富士通' vendor_nm, 3 bunya_cd,'固定資産税'     bunya_nm ,  2 kensu , '固定' ryaku_nm union all 
select '富士通' vendor_nm, 4 bunya_cd,'個人住民税'     bunya_nm ,  0 kensu , '民税' ryaku_nm union all 
select '富士通' vendor_nm, 5 bunya_cd,'軽自動車税'     bunya_nm ,  2 kensu , '軽自' ryaku_nm union all 
select '富士通' vendor_nm, 6 bunya_cd,'国民健康保険'   bunya_nm ,  9 kensu , '国保' ryaku_nm union all 
select '富士通' vendor_nm, 7 bunya_cd,'国民年金'       bunya_nm ,  2 kensu , '年金' ryaku_nm union all 
select '富士通' vendor_nm, 8 bunya_cd,'障害者福祉'     bunya_nm ,  4 kensu , '障害' ryaku_nm union all 
select '富士通' vendor_nm, 9 bunya_cd,'後期高齢者医療' bunya_nm ,  0 kensu , '後期' ryaku_nm union all 
select '富士通' vendor_nm,10 bunya_cd,'介護保険'       bunya_nm , 17 kensu , '介護' ryaku_nm union all 
select '富士通' vendor_nm,11 bunya_cd,'児童手当'       bunya_nm ,  0 kensu , '児童' ryaku_nm union all 
select '富士通' vendor_nm,12 bunya_cd,'生活保護'       bunya_nm ,  2 kensu , '生保' ryaku_nm union all 
select '富士通' vendor_nm,13 bunya_cd,'健康管理'       bunya_nm ,  2 kensu , '健康' ryaku_nm union all 
select '富士通' vendor_nm,14 bunya_cd,'就学援助'       bunya_nm ,  2 kensu , '就学' ryaku_nm union all 
select '富士通' vendor_nm,15 bunya_cd,'財務会計'       bunya_nm ,  1 kensu , '財務' ryaku_nm union all 
select '富士通' vendor_nm,16 bunya_cd,'起債管理'       bunya_nm ,  1 kensu , '起債' ryaku_nm union all 
select '富士通' vendor_nm,17 bunya_cd,'備品管理'       bunya_nm ,  1 kensu , '備品' ryaku_nm union all 
select '富士通' vendor_nm,18 bunya_cd,'財産管理'       bunya_nm ,  18 kensu , '財産' ryaku_nm union all 
select '富士通' vendor_nm,19 bunya_cd,'公会計'         bunya_nm ,  2 kensu , '公会' ryaku_nm union all 
select '富士通' vendor_nm,20 bunya_cd,'行政評価'       bunya_nm ,  18 kensu , '行政' ryaku_nm union all 
select '富士通' vendor_nm,21 bunya_cd,'実施計画'       bunya_nm ,  0 kensu , '実計' ryaku_nm union all 
select '富士通' vendor_nm,22 bunya_cd,'源泉徴収'       bunya_nm ,  0 kensu , '源泉' ryaku_nm union all 
select '富士通' vendor_nm,23 bunya_cd,'人事給与'       bunya_nm ,  0 kensu , '給与' ryaku_nm union all 
select '富士通' vendor_nm,24 bunya_cd,'人事評価'       bunya_nm ,  0 kensu , '評価' ryaku_nm union all 
select '富士通' vendor_nm,25 bunya_cd,'文書管理'       bunya_nm ,  0 kensu , '文書' ryaku_nm union all 
select '富士通' vendor_nm,26 bunya_cd,'旅費管理'       bunya_nm ,  1 kensu , '旅費' ryaku_nm union all 
select '富士通' vendor_nm,27 bunya_cd,'庶務事務'       bunya_nm ,  5 kensu , '庶務' ryaku_nm union all 
select '富士通' vendor_nm,28 bunya_cd,'グループウェア' bunya_nm ,  6 kensu , 'ＧＷ' ryaku_nm union all 
select '富士通' vendor_nm,29 bunya_cd,'水道料金'       bunya_nm ,  7 kensu , '水道' ryaku_nm union all 
select '富士通' vendor_nm,30 bunya_cd,'企業会計'       bunya_nm ,  2 kensu , '企業' ryaku_nm  ;
